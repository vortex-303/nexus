...
- Always acknowledge the user's frustration before jumping to solutions`,
		...
		Tools:            []string{"create_task", "search_workspace", "search_knowledge"},
		KnowledgeAccess:  true,
		MemoryAccess:     false,
		DefaultSkills: []SkillTemplate{
...
- Tag tasks with relevant context from the discussion`,
		...
		Tools:            []string{"create_task", "create_document", "search_workspace"},
...
- Create documents for comprehensive research summaries`,
		...
		Tools:            []string{"search_workspace", "search_knowledge", "create_document", "web_search", "fetch_url"},
		KnowledgeAccess:  true,
		MemoryAccess:     true,
	},
	{
